...
const EditJobPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const updatedJob = {
      ...
      company: {
        name: editJob.company_name,
        description: editJob.company_description,
        contactEmail: editJob.contact_email,
        contactPhone: editJob.contact_phone,
      },
    };
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                value={editJob.company_description}
                onChange={handleInputChange}
                className="border rounded w-full py-2 px-3"
                rows="4"
